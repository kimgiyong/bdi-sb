...
public class Transper {
	...
	private static String clientId = "RfATdtwtvDjMwDOrc8ax";
	private static String clientSecret = "vyQr8HWQ1h";
	...
	public static void main(String args[]) {
		...
		if(koStr.trim().length()>100) {
			System.out.println("번역할 글자는 100글자 이내입니다");
			return ;
		}
		String regex = "^[ㄱ-ㅎ가-힣\\s]*$";
